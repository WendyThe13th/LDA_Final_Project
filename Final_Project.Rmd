...
```{r}
#cursmoke
pnorm(-11.20762/1.83644)
```
```{r}
#CI cursmoke
-11.20762-1.96*1.83644
-11.20762+1.96*1.83644
```
```{r}
#bmi
1-pnorm(0.98322/0.03816)
```
```{r}
#CIbmi
0.98322-1.96*0.03816
0.98322+1.96*0.03816
```

```{r}
#sex
pnorm(-0.51623/0.29304)
```
```{r}
#CI sex
-0.51623-1.96*0.29304
-0.51623+1.96*0.29304
```
```{r}
#age
pnorm(-0.05122/0.01442)
```
```{r}
#CI age
-0.05122-1.96*0.01442
-0.05122+1.96*0.01442
```
```{r}
#cursmoke1:bmi   
1-pnorm(0.09296/0.05477)
```
```{r}
#cursmoke1:bmi   
0.09296-1.96*0.05477
0.09296+1.96*0.05477
```

```{r}
#cursmoke1:age   
1-pnorm(0.16113/0.02129)
```
```{r}
#cursmoke1:age  
0.16113-1.96*0.02129
0.16113+1.96*0.02129
```
