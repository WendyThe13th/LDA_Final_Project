...
```{r}
#adjust sex
cursmoke_adj_sex <- lm(cursmoke~sex, data = smoke)$residuals
age_adj_sex <- lm(age~sex, data = smoke)$residuals
adj_res_sex <- tibble(id=smoke$randid, cursmoke_adj_sex=cursmoke_adj_sex, age_adj_sex=age_adj_sex)
...
```{r}
#adjust totchol
cursmoke_adj_totchol <- lm(cursmoke~totchol, data = smoke)$residuals
age_adj_totchol <- lm(age~totchol, data = smoke)$residuals
adj_res_totchol <- tibble(id=smoke$randid, cursmoke_adj_totchol=cursmoke_adj_totchol, age_adj_totchol=age_adj_totchol)
